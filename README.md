...
Репозиторий содержит реализацию мультимодального агента на основе Vision-Language Model (VLM) и бибилиотеки nanoVLM (HuggingFace) для задачи навигации в двумерной grid-среде.
